...
-- Copiando dados para a tabela escola.dados_pessoais: ~15 rows (aproximadamente)
INSERT INTO `dados_pessoais` (`id_aluno`, `nome_aluno`) VALUES
	('S001', 'Ana Beatriz Lima'),
	('S002', 'Bruno César Santos'),
	('S003', 'Camila Dantas Silva'),
	('S004', 'Daniel Elias Costa'),
	('S005', 'Eduarda Ferreira Melo'),
	('S006', 'Fábio Gomes Nunes'),
	('S007', 'Lucas Silva Almeida'),
	('S008', 'Mariana Oliveira Souza'),
	('S009', 'Pedro Henrique Costa'),
	('S010', 'Rafael Oliveira Pereira'),
	('S011', 'Juliana Almeida Pereira'),
	('S012', 'Felipe Barbosa Lima'),
	('S013', 'João Pedro Rodrigues Silva'),
	('S014', 'Fernanda Machado Costa'),
	('S015', 'Eduardo Gomes da Silva');

-- Copiando estrutura para tabela escola.log
CREATE TABLE IF NOT EXISTS `log` (
  `id_usuario` int(11) NOT NULL AUTO_INCREMENT,
  `data-hora` datetime NOT NULL,
  `sql-executado` text DEFAULT NULL,
  `ip_usuario` varchar(50) DEFAULT NULL,
  `parametro` text DEFAULT NULL,
  `resultado` enum('Y','N') NOT NULL,
  PRIMARY KEY (`id_usuario`),
  UNIQUE KEY `ip_usuario` (`ip_usuario`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Copiando dados para a tabela escola.log: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela escola.notas_alunos: ~200 rows (aproximadamente)
INSERT INTO `notas_alunos` (`id_aluno`, `horas_estudadas`, `horas_sono`, `percentual_presenca`, `notas_anteriores`, `nota_exame`) VALUES
	('S001', 8, 8.8, 72.1, 45, 30.2),
	('S002', 1.3, 8.6, 60.7, 55, 25),
	('S003', 4, 8.2, 73.7, 86, 35.8),
	('S004', 3.5, 4.8, 95.1, 66, 34),
	('S005', 9.1, 6.4, 89.8, 71, 40.3),
	('S006', 8.4, 5.1, 58.5, 75, 35.7),
	('S007', 10.8, 6, 54.2, 88, 37.9),
	('S008', 2, 4.3, 75.8, 55, 18.3),
	...
	('S109', 6, 8, 52.5, 43, 23.2),
	('S110', 11.5, 8.3, 69, 49, 42.2),
	('S111', 10.6, 8.5, 60.6, 49, 39.6),
	('S112', 3.9, 5.1, 66.3, 91, 34.8),
	('S113', 6.5, 5.2, 88.1, 76, 34.6),
	('S114', 3, 4.5, 69, 59, 26.4),
	('S115', 11, 7.9, 87.6, 45, 43.1),
	('S116', 10.6, 8.4, 91.6, 55, 46.4),
	('S117', 4.3, 6, 62.6, 47, 25.2),
	('S118', 8, 7.1, 54.1, 75, 31.3),
	('S119', 7.7, 4.8, 51, 88, 35.8),
	('S120', 2.7, 8.6, 77, 66, 29.8),
	('S121', 9.4, 8.3, 100, 78, 47.9),
	('S122', 6.9, 8.9, 67.5, 78, 40.9),
	('S123', 9.6, 8.1, 82.5, 90, 44.1),
	('S124', 6.8, 8.4, 89.1, 79, 39.3),
	('S125', 1, 4.1, 82.6, 54, 21.2),
	('S126', 4.6, 7.7, 87.7, 89, 38.6),
	('S127', 1.2, 5.7, 97.5, 73, 26.8),
	('S128', 11.2, 8.7, 60, 64, 42.7),
	('S129', 10.7, 8, 51, 68, 36.1),
	...
	('S135', 1.9, 8.4, 85, 59, 30.6),
	('S136', 6.3, 8.3, 88.3, 76, 41.1),
	('S137', 1.8, 5.1, 58.4, 79, 29),
	('S138', 9.4, 8.1, 80.4, 43, 35.1),
	('S139', 9.4, 6.3, 87.4, 79, 39.9),
	('S140', 2.4, 5.5, 55.7, 87, 29.9),
	('S141', 6.2, 8, 91, 46, 35),
	('S142', 7, 5.1, 98.2, 88, 43.3),
	('S143', 3.9, 4.1, 55.4, 53, 19),
	('S144', 10.6, 5, 51.3, 80, 35.1),
	('S145', 5.7, 5.6, 65.6, 53, 29.9),
	('S146', 3.3, 8.3, 83.9, 56, 33),
	('S147', 6.9, 8.8, 97.9, 82, 45.8),
	('S148', 9, 5.4, 69.8, 45, 35.5),
	('S149', 3.2, 7.2, 85.8, 50, 26.4),
	('S150', 4.4, 6, 53.8, 55, 21.9),
...
-- Copiando dados para a tabela escola.usuarios_login: ~1 rows (aproximadamente)
INSERT INTO `usuarios_login` (`id_usuario`, `nome_usuario`, `senha_hash`) VALUES
	(1, 'Tiago Padovani', '50123fd713092ab9606e6468d72d19fc1f41dd0bf5f1cd42c386df56b1f5c7b1'),
	(2, 'Maria', '9350f6a0acb9e6d87b3e23fe7830926174215b122a289e45f2ad35b4db57d7a9');
